...
const PostCard = (post: Post) => {
    return (
        <div className="flex flex-col space-y-3 rounded-xl border p-6 shadow cursor-pointer hover:bg-accent transition ease-in-out">
...
export const Post = () => {
    return (
        <div className="flex flex-col mx-auto p-4 w-full">
            ...
            <p className="text-xs text-zinc-500 mb-6">Things I wrote</p>
